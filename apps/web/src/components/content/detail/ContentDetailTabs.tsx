import { MovieDetailResponse } from "@api/dto/movie.dto";
    ...
    <>
      ...
      {data.id && (
        <div className="tab-content">
          <Activity
            mode={activeTab === CONTENT_TAB_TYPE.INFO ? "visible" : "hidden"}
          >
            <ContentInfoTab credits={data.credits ?? []} />
          </Activity>
          <Activity
            mode={activeTab === CONTENT_TAB_TYPE.RELATED ? "visible" : "hidden"}
          >
