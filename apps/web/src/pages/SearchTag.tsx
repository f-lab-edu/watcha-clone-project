...
import { contentListByGenreQueryOptions, genresQueryOptions } from '@watcha/queries';
      ...
      <div className='sp-filter-row'>
        {genreData.genres.map((g) => (
          <button
            ...
            onClick={() => {
              setActiveGenreFilter((prev: Genre | null) => (prev?.id !== g.id ? g : prev));
